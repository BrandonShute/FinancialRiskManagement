...
class FixedRateBond(Bond):
    ...
    def __init__(self, ID, currency, start_date, maturity_date, face_value,
                 ...
                 first_coupon_date=None, industry=None, sector=None,
                 subsector=None, country=None, rf_ID=None, val_spec=None):
        super(FixedRateBond, self).__init__(ID, currency, start_date,
                                            maturity_date, face_value, 'Fixed',
                                            coupon_rate, coupon_freq, issuer,
                                            ratings, tier, day_count,
                                            first_coupon_date, industry, sector,
                                            subsector, country, rf_ID, val_spec)
...
if __name__ == '__main__':
    ...
    country = 'Canada'
    fixed_rate_bond_test = FixedRateBond(ID, currency, start_date,
                                         maturity_date, face_value, coupon_rate,
                                         coupon_freq, issuer, ratings, tier,
                                         day_count, first_coupon_date, industry,
